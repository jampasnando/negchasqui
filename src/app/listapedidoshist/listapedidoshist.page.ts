...
@Component({
  selector: 'app-listapedidoshist',
  templateUrl: './listapedidoshist.page.html',
  styleUrls: ['./listapedidoshist.page.scss'],
})
export class ListapedidoshistPage implements OnInit {
  idneg="";
  nombreneg="";
  listapedidos:any;
  audio:any;
  ...
  ngOnInit() {
    ...
    this.consultas.listapedidoshist(this.idneg).subscribe((datos:any)=>{
