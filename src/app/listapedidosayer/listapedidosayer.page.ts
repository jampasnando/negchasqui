...
@Component({
  selector: 'app-listapedidosayer',
  templateUrl: './listapedidosayer.page.html',
  styleUrls: ['./listapedidosayer.page.scss'],
})
export class ListapedidosayerPage implements OnInit {
  idneg="";
  nombreneg="";
  listapedidos:any;
  audio:any;
  ...
  nroe=0;
  interv:any;
  constructor(private menu:MenuController,private consultas:ServiciosService,private modalCtrl:ModalController) { }
  ...
  ngOnInit() {
    ...
    this.consultas.listapedidosayer(this.idneg).subscribe((datos:any)=>{
